...
export class RendererCanvas2d {
  ...
  private scatterGL: scatter.ScatterGL;
  private scatterGLHasInitialized: boolean;
  private videoWidth: any;
  private videoHeight: any;
  constructor(canvas: HTMLCanvasElement) {
    this.ctx = canvas.getContext('2d');
    this.scatterGLEl = document.querySelector('#scatter-gl-container') as HTMLDivElement;
